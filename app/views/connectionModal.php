        ...
        <div class="modalContent">
            <form name="connection">
                <div class="form-group">
                    ...
                    <input id="uEmailCo" class="form-control" ng-class="{errorBackEnd: userExistCo === true || wrongMailCo === true}" name="uEmailCo" ng-model="userCo.email" type="email" ng-focus="focusInputModal('uEmailCo')" ng-blur="blurInputModal('uEmailCo')" ng-click="userExistCo = false; wrongMailCo = false" required="">
                ...
                <div class="form-group">
                    ...
                    <input id="uPasswordCo" class="form-control" name="uPasswordCo" ng-model="userCo.password" type="password" ng-focus="focusInputModal('uPasswordCo')" ng-blur="blurInputModal('uPasswordCo')" ng-minlength="5" ng-maxlength="20" required="">
                    <div class="errorInfos">
