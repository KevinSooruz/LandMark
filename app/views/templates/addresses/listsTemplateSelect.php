<div class="form-group noMargin">
    ...
    <div class="col-md-10 col-sm-10">
        <select ng-show="lists.length > 0" class="form-control select" ng-model="addAddress.list" name="listSelect" ng-options="list.name for list in lists" ng-click="selectList()">
