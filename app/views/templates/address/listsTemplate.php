<div class="inBox other">
    <span class="title">Ajouter dans une liste</span>
    <div class="inBoxContent">
        <div class="multiContent" ng-hide="lists.length === 0; errorBackEnd === true">
            <select ng-show="lists.length > 0" class="form-control select" ng-model="listChange" ng-options="list.name for list in lists" ng-click="selectList()">
        ...
        <div class="multiContent textRight" ng-hide="lists.length === 0; errorBackEnd === true">
            <button class="btn btnPrimary btnMidWidth">Ajouter</button>
        </div>
